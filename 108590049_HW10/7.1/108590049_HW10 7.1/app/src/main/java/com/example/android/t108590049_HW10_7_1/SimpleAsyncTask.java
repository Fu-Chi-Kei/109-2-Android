 ...
 */
package com.example.android.t108590049_HW10_7_1;
...
public class SimpleAsyncTask extends AsyncTask<Void,Integer, String> {
    ...
    private WeakReference<ProgressBar> mTextProgressBar;
    private static final int CHUNK = 100;
    // Constructor that provides a reference to the TextView from the MainActivity
    SimpleAsyncTask(TextView tv, ProgressBar pb) {
        mTextView = new WeakReference<>(tv);
        mTextProgressBar = new WeakReference<>(pb);
    }
    ...
    protected void onProgressUpdate(Integer... values) {
        mTextProgressBar.get().setProgress(values[0]);
    }
    /**
