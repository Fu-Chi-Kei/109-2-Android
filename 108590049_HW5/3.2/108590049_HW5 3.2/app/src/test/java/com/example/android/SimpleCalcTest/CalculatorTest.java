...
public class CalculatorTest {
     ...
     * vvvvvvvvvvvvv MY TEST vvvvvvvvvvvvvvvvv
     */
    @Test/*具有正整數操作數的測試。*/
    public void pow_Two_Numbers() {
        double resultPow = mCalculator.pow(3d, 3d);
        assertThat(resultPow, is(equalTo(27d)));
    }
    @Test/*以負整數作為第一個操作數的測試。*/
    public void pow_First_Negative() {
        double resultPow = mCalculator.pow(-3d, 3d);
        assertThat(resultPow, is(equalTo(-27d)));
    }
    @Test/*以負整數作為第二個操作數的測試。*/
    public void pow_Second_Negative() {
        double resultPow = mCalculator.pow(4d, -1d);
        assertThat(resultPow, is(equalTo(0.25d)));
    }
    @Test/*以0作為第一個操作數，以正整數作為第二個操作數的測試。*/
    public void pow_First_Zero() {
        double resultPow = mCalculator.pow(0d, 5d);
        assertThat(resultPow, is(equalTo(0d)));
    }
    @Test/*以0作為第二個操作數的測試。*/
    public void pow_Second_Zero() {
        double resultPow = mCalculator.pow(2d, 0d);
        assertThat(resultPow, is(equalTo(1d)));
    }

    @Test/*一個測試，第一個操作數為0，第二個操作數為-1。*/
    public void pow_First_Zero_Second() {
        double resultPow = mCalculator.pow(-0d, -1d);
        assertThat(resultPow, is(equalTo(Double.NEGATIVE_INFINITY)));
    }
    @Test/*以-0作為第一個操作數，任何負數作為第二個操作數的測試。*/
    public void pow_First_Odd_Second_Negative_Zero() {
